...
<head>
    <meta charset="UTF-8">
    <link rel="icon" href="static/dollar.png" type="image/png" sizes="16x16">
...
<body>
    ...
    <button type="button" class="btn btn-outline-success"><a href="customer.jsp"> Submit</a></button></button>
</body>
</html>
