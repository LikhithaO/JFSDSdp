    ...
    <div id="mySidenav" class="sidenav">
        ...
        <div class="container" style="margin-left: 10000px;margin-top: 5rem; float: right; width: 75%; padding: 0 5rem 0 5rem;background-color:rgba(23, 67, 88, 0.5) ;">
          <h2>Manage Flights</h2>
           <hr>
            <div>
              <button class="btn btn-primary"><a href="#" style="color: white"><i class="fa fa-plus"></i> New Flight</a></button>
            </div>
            <br>
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <td><a href='<c:url value="view?id=${flight.id}"></c:url>'><b>View</b></a>
                  </td>
                  <td>
          <a href='<c:url value="delete/${flight.id}"></c:url>'>Delete</a>
          </td>
                  <td>
          <a href='<c:url value="updateflight/${flight.id}"></c:url>'>Update</a>
          </td>
                  </tr></c:forEach> 
            </tbody>
        </table>
